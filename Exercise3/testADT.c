...
void printStructADT(DataObject* dat, void* _) {
    printf("- ");
...
void mapLowerCaseADT(DataObject* dat, void* _) {
...
void mapUpperCaseADT(DataObject* dat, void* _) {
    for(int i = 0; i<strlen((char*)dat->value); i++) {
...
void foldConcatLessOrEqThanNADT(DataObject * dat, void *val, void *n) {
...
void testStack() {
    ...
    do {
        ...
        switch (scelta) {
            ...
            case 2: {
                if(!stkEmpty(stack)) {
                    stkMap(stack, printStructADT, NULL);
                } else {
            ...
            case 3: {
                switch (tipoScelto) {
                    ...
                    case 3: {
                        ...
                        getStr(buffer, MaxStrLen);
                        *n = strtol(buffer, NULL, 10);
                        stkFold(stack, foldConcatLessOrEqThanNADT, value, n);
                        printf("Risultato: %s\n", value);
            ...
            case 4: {
                switch (tipoScelto) {
                    ...
                    case 3: {
                        ...
                        switch (scelta) {
                            case 1: {
                                stkMap(stack, mapUpperCaseADT, NULL);
                                break;
                            }
                            case 2: {
                                stkMap(stack, mapLowerCaseADT, NULL);
                                break;
                            }
                            default: {
            ...
            case 11: {
                ...
                stkMap(stackClone, printStructADT, NULL);
...
void testQueue() {
    ...
    do {
        ...
        switch (scelta) {
            ...
            case 2: {
                if(!queEmpty(queue)) {
                    queMap(queue, printStructADT, NULL);
                } else {
            ...
            case 3: {
                switch (tipoScelto) {
                    ...
                    case 3: {
                        ...
                        getStr(buffer, MaxStrLen);
                        *n = strtol(buffer, NULL, 10);
                        queFold(queue, foldConcatLessOrEqThanNADT, value, n);
                        printf("Risultato: %s\n", value);
            ...
            case 4: {
                switch (tipoScelto) {
                    ...
                    case 3: {
                        ...
                        switch (scelta) {
                            case 1: {
                                queMap(queue, mapUpperCaseADT, NULL);
                                break;
                            }
                            case 2: {
                                queMap(queue, mapLowerCaseADT, NULL);
                                break;
                            }
                            default: {
                                printf("Scleta non valida\n");
            ...
            case 11: {
                ...
                queMap(queueClone, printStructADT, NULL);
